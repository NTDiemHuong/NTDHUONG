...
{
    public class NTDH_MemberController : Controller
    {
        ...
        [HttpPost]
        public ActionResult CreateOne(NTDH_Member m)
        {
            //chuyển dữ liệu nhận được tới View Details
            return View("Details", m);
        }
        //GET: /Member/CreateTwo 
        public ActionResult CreateTwo(NTDH_Member m)
        {
            return View();
        }
        ...
        [HttpPost]
        public ActionResult CreateThree(NTDH_member m)
        {
